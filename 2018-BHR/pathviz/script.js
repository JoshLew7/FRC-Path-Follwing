var waypoints = [];
var ctx;
var width = 1653; //pixels
var height = 834; //pixels
var fieldWidth = 652; // in inches
var fieldHeight = 328; // in inches
var robotWidth = 34.16; //inches
var robotHeight = 37.85; //inches
var pointRadius = 5;
var turnRadius = 30;
var kEpsilon = 1E-9;
var image;
...
var h;
function create() {
	var a = new Waypoint(new Translation2d(18,70), 0,0,0)
	var b = new Waypoint(new Translation2d(220,70),30,60,0)
	var c = new Waypoint(new Translation2d(260,85),30,60,0)
	var d = new Waypoint(new Translation2d(280,85),0,60,0)
	var e = new Line(a, b);
	var f = new Line(b, c);
	var g = new Line(c, d);
	h = new Arc(f, g);
...
function addPoint() {
	...
	if(waypoints.length > 0)
		...
		prev = new Translation2d(18, 70);
	$("tbody").append("<tr>"
		+"<td><input value='"+(prev.x+20)+"'></td>"
		+"<td><input value='"+(prev.y+0)+"'></td>"
		+"<td><input value='0'></td>"
...
function getDataString() {
	...
	var str = `package frc.team3310.paths.auton;
