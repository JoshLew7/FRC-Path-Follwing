...
public class DriveMotionPlannerTest {
        ...
        private Pose2d kCargoSideTurnToLoadingPose = new Pose2d(new Translation2d(295.75, -60.5),
        ...
        public void testStraight() {
                ...
                motion_planner.setTrajectory(
                                new TrajectoryIterator<>(new TimedView<>(lazyTrajectory.getTrajectory().right)));
                ...
                while (!motion_planner.isDone()) {
                        ...
                        pose = motion_planner.mSetpoint.state().getPose();// .transformBy(new Pose2d(new
        ...
        public void testForwardWithTheta180() {
                ...
                motion_planner.setTrajectory(
                                new TrajectoryIterator<>(new TimedView<>(motion_planner.generateTrajectory(false,
                                                Arrays.asList(kCargoSideTurnToLoadingPose, kLoadingPose), null, 120.0,
                                                120.0, 10.0))));
                double t = 0.0;
                Pose2d pose = motion_planner.setpoint().state().getPose();
        ...
        public void testForwardReverseSame180Theta() {
                ...
                fwd_motion_planner.setTrajectory(
                                new TrajectoryIterator<>(new TimedView<>(fwd_motion_planner.generateTrajectory(false,
                                                Arrays.asList(kCargoSideTurnToLoadingPose, kLoadingPose), null, 120.0,
                                                120.0, 5.0))));
                ...
                rev_motion_planner.setTrajectory(
                                new TrajectoryIterator<>(new TimedView<>(rev_motion_planner.generateTrajectory(true,
                                                Arrays.asList(kLoadingPose, kCargoSideTurnToLoadingPose), null, 120.0,
                                                120.0, 5.0))));
        ...
        public void testForwardReverseSame() {
                ...
                fwd_motion_planner.setTrajectory(new TrajectoryIterator<>(
                                new TimedView<>(fwd_motion_planner.generateTrajectory(false, Arrays.asList(
                                                new Pose2d(new Translation2d(10.0, 10.0), Rotation2d.fromDegrees(5.0)),
                                                new Pose2d(new Translation2d(120.0, 36.0), Rotation2d.identity()),
                                                new Pose2d(new Translation2d(230.0, 10.0),
                                                                Rotation2d.fromDegrees(-5.0))),
                                                null, 120.0, 120.0, 5.0))));
                DriveMotionPlanner rev_motion_planner = new DriveMotionPlanner();
                rev_motion_planner.setFollowerType(DriveMotionPlanner.FollowerType.PURE_PURSUIT);
                rev_motion_planner.setTrajectory(new TrajectoryIterator<>(
                                new TimedView<>(rev_motion_planner.generateTrajectory(true, Arrays.asList(
                                                new Pose2d(new Translation2d(230.0, 10.0),
                                                                Rotation2d.fromDegrees(-5.0)),
                                                new Pose2d(new Translation2d(120.0, 36.0), Rotation2d.identity()),
                                                new Pose2d(new Translation2d(10.0, 10.0), Rotation2d.fromDegrees(5.0))),
        ...
        public void testFollowerReachesGoalTheta180() {
                ...
                System.out.println(motion_planner.setpoint().toCSVHeader() + ", leftOutputVel, rightOutputVel,"
                                + initial_error.toCSVHeader());
                while (!motion_planner.isDone()) {
                        ...
                        t += dt;
                        System.out.println(motion_planner.setpoint().toCSV() + "," + output.left_velocity + ","
                                        + output.right_velocity + "," + motion_planner.error().toCSV());
                }
        ...
        public void testVoltages() {
                ...
                motion_planner.setTrajectory(new TrajectoryIterator<>(new TimedView<>(motion_planner.generateTrajectory(
                                ...
                                Arrays.asList(Pose2d.identity(), Pose2d.fromTranslation(new Translation2d(48.0, 0.0)),
                                                ...
                                                new Pose2d(new Translation2d(96.0, 96.0),
